...
class _EpisodeCardState extends State<EpisodeCard> {
  ...
  Future<String> getData_Video(RawLink) async {
    var response = await http.get(
        Uri.parse("https://www.animeworld.tv/api/episode/info?alt=0&id="+RawLink),headers: {"x-requested-with": "XMLHttpRequest","user-agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36"}..addAll(globals.cookie));
